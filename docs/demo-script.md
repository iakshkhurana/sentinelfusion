...
| 25–45s | Select **Hot work beside rising CO** → **Run** (or **Skip ahead** then watch compound fire). |
| 45–70s | CRITICAL: hit **Pause**. Point Hot zone + PTW + vision + race (Fusion before Baseline). **Resume**. |
